...
exports.commands = {
	...
	mktour: function(target, room, user) {
		if (!target) return this.errorReply("Usage: /etour [tier] - creates a tournament in single elimination.");
		target = toId(target);
		var t = target;
...
Gold.pmAll = function(message, pmName) {
	pmName = (pmName ? pmName : '~Wish Server [Do not reply]');
