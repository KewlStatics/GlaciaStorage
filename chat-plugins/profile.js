...
exports.commands = {
    profile: function(target, room, user) {
        ...
        if (!targetUser) {
            ...
            var online = false;
            var avatar = (Config.customavatars[userid] ? serverIp + ":" + "8000" + "/avatars/" + Config.customavatars[userid] : "http://play.pokemonshowdown.com/sprites/trainers/167.png");
        } else {
            var username = targetUser.name;
            var userid = targetUser.userid;
            var online = targetUser.connected;
            var avatar = (isNaN(targetUser.avatar) ?  serverIp + ":" + "8000" + "/avatars/" + targetUser.avatar : "http://play.pokemonshowdown.com/sprites/trainers/" + targetUser.avatar + ".png");
        }
        ...
        function showProfile() {
            ...
            if (Users.vips[userid]) profile += '&nbsp;<font color=' + formatHex + '><b>Rank: </font></b>' + userGroup + ' (<font color=blue><b>Glacia VIP</b></font>)<br />';
