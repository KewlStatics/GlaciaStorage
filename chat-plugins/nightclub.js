...
exports.commands = {
	nightclub: function(target, room, user, connection) {
		...
		room.addRaw('<div class="nightclub"><font size=6>' + nightclubify('Ooooooh Glacia don't you dare be sour! Clap for your nightclub and feeeeeellll the powah!) + '</font><font size="2"> started by: ' + user.userid + '</font></div>');
	},
